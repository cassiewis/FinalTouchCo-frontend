...
export const routes: Routes = [
    ...
    { path: 'inspo', loadComponent: () => import('./inspo/inspo.component').then((m) => m.InspoComponent), canActivate: [ConstructionGuard] },
    { path: 'testimonials', loadComponent: () => import('./inspo/inspo.component').then((m) => m.InspoComponent), canActivate: [ConstructionGuard] },
